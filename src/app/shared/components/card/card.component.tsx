...
const CardComponent: FC<Readonly<ICardProps>> = ({ settings }) => {
    return (
        <div className={`${styles.cart} flex-col flex`}>
            ...
            >
                ...
                <div className="flex justify-between p-3 pt-24">
                    <div className="flex flex-col">
                        <h5>BC “Victory Plaza”</h5>
                        <h6>Бізнес-центр | Клас А</h6>
                    </div>
            ...
            <div className={`${styles.textPart} flex flex-col gap-2 p-7`}>
                <div className="flex gap-2 items-center">
                    ...
                    <div className="flex flex-col">
                        <p>м. Івано-Франківськ, р-н Центральний</p>
                        <span className="text-xs">вул. Еспланадна 1</span>
                    </div>
                </div>
                ...
                <div className="flex gap-4 items-center">
                    <div className="flex flex-col numbM">
                ...
                <div className="flex gap-2 items-center">
                    <div className={`${styles.itemRed} flex`}>
                        <h5 className={styles.titRed}>+ OPEX 5$/m2/мес</h5>
                    </div>
                    <div className={`${styles.itemBlue} flex`}>
                        <h5 className={styles.titBlue}>+ НДС</h5>
                    </div>
                    <div className={`${styles.itemLavender} flex`}>
                        <h5 className={styles.titLavender}>+ R/U - 10%</h5>
                    </div>
                </div>
            </div>
        </div>
