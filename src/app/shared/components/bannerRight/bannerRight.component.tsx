  ...
  return (
    ...
    >
      <div className='flex m-auto flex-col items-center justify-center gap-6'>
        <h4 className={`${titleClassName} text-white text-2xl font-bold leading-8`}>{title}</h4>
        {subtitle && <h6 className='text-white font-medium text-sm text-center'>{subtitle}</h6>}
