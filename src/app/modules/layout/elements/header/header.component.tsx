...
const HeaderComponent: FC = () => {
  ...
  return (
    <header
      className={`${styles.header} flex lg:gap-0 gap-4 justify-center items-center p-5`}
    >
      <div className={`${styles.headerWrap} flex sm:gap-0 gap-5 items-center`}>
        ...
        >
          ...
          <div className="flex items-center justify-between w-full p-4">
            <button
              className={`${styles.wishlist} items-center justify-center flex`}
            >
              <Image src={Like} alt="icon" width={20} height={19} />
            </button>
            <button
              className={`${styles.notifications} items-center justify-center flex`}
            >
          ...
          <button
            className={`${styles.add} flex items-center ml-3 gap-2 text-white`}
          >
      ...
      <div className="flex lg:flex-row flex-col lg:gap-0 gap-5">
        <div className="flex gap-3 lg:pl-4 xl:pl-9">
          <button
            className={`${styles.add} lg:flex hidden items-center gap-2 text-white`}
          >
            <Image src={AddOffice} alt="icon" width={14} height={14} />
            Додати офіс
          </button>
