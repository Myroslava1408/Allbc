    ...
    <section className={`flex flex-col ${styles.OfficeProperty}`}>
      <div className={`flex flex-col gap-12 ${styles.PropertyWrap}`}>
        <DistrictOfficesComponent
          districts={districtsForSale}
          title={'Продаж офісу по районаx:'}
        />
        <MetroOfficesComponent
          ...
          stations={stations}
        />
        <CityOfficesComponent
          cities={cities}
          title={'Оренда офісу по містах:'}
        />
        <DistrictOfficesComponent
          districts={districtsForRent}
          title={'Оренда офісу по районаx:'}
        />
        <OfficeAreasComponent
          settings={settings}
          title={'Оренда офісу по площі:'}
          areas={areas}
        />
      </div>
    </section>
